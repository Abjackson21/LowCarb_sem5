                    ...
                    <div class="profile-container">
                      <form action="/updateProfile" method="post" id="profileForm">
                        ...
                        <div class="profile-row">
                            ...
                            <div class="profile-col-85">
                                <textarea id="address" name="address" style="height:60px">${user.getAddress()}</textarea>
                            </div>
                        </div>
                        <div class="profile-row">
                            <div class="profile-col-10">
                        ...
                        <div class="profile-row">
                            ...
                            <div class="profile-col-35">
                                <input type="text" id="phone" name="phone" placeholder="${user.getPhoneNumber()}" style="height:20px">
                            </div>
                        </div>
                        <div class="profile-row">
                            <div class="profile-col-10">
